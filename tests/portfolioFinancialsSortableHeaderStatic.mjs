...
if (!html.includes('17.10-portfolio-financial-filters-projections-20260703')) throw new Error('V17.10 cache-busting tag missing from index.html.');
if (!app.includes('V17.10 portfolio financial filters and projections')) throw new Error('V17.10 app build marker missing.');
