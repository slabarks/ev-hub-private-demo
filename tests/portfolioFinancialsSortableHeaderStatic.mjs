...
if (!html.includes('17.7-portfolio-financial-audit-20260703')) throw new Error('V17.7 cache-busting tag missing from index.html.');
if (!app.includes('V17.7 portfolio financial audit')) throw new Error('V17.7 app build marker missing.');
