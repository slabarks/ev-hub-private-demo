...
class LiveFinancialMaturityTests(unittest.TestCase):
    def test_monthly_history_is_retained_for_mature_and_early_sites(self):
        ...
        self.assertEqual(payload["schemaVersion"], "v17.45-live-history-v6")
        self.assertEqual(payload["buildId"], "EVHUB-V17.45-20260711-R1")
        self.assertEqual(payload["parserBuildId"], "EVHUB-LIVE-PARSER-17.45.1")
