...
class LiveFinancialMaturityTests(unittest.TestCase):
    def test_monthly_history_is_retained_for_mature_and_early_sites(self):
        ...
        self.assertEqual(payload["schemaVersion"], "v17.44-live-history-v5")
        self.assertEqual(payload["buildId"], "EVHUB-V17.44-20260710-R1")
        self.assertEqual(payload["parserBuildId"], "EVHUB-LIVE-PARSER-17.44.1")
