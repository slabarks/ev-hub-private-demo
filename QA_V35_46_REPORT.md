# QA Report — v35.46 Banner Full-Configuration Consistency Fix
...
The package is short-path safe and below the user's GitHub file-count constraint. Historical QA reports from older builds were removed from the release package; the current v35.46 QA report is retained.


## v35.46 Additional fix

- Banner Plaza Ennis now loads and models the canonical full installed/project configuration: 2 × Kempower Triple Cabinets, 4 dual satellites and 8 plugs.
- The partial live activation state remains a metadata/audit note only; it no longer changes Product Configuration or Portfolio Comparison model configuration.
- Hardware regression now verifies Banner derives 1,200 kW installed charger power and 8 outputs.
